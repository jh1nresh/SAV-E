...
struct PlatformIcon: View {
    ...
    private var iconName: String {
        ...
        case .meituan: return "fork.knife.circle.fill"
        case .taobaoInstantCommerce: return "bag.fill"
    ...
    private var iconColor: Color {
        switch platform {
        case .instagram, .threads, .xiaohongshu, .douyin, .dianping, .meituan, .taobaoInstantCommerce, .googleMaps, .appleMaps, .amap, .baidu: return .saveCocoa
