...
-- Correlated social-analysis accounting and recovery (also available as standalone migration).
...
-- Restricted, revocable Share Extension sessions. Tokens are stored only as
-- SHA-256 hashes; analysis claims prevent billed replay and input substitution.
