...
create table public.places (
    ...
    coordinate_system text not null default 'WGS84' check (coordinate_system in ('WGS84', 'GCJ-02', 'BD-09')),
    location_provider text check (location_provider in ('apple_maps', 'google_places', 'amap', 'baidu')),
    provider_place_id text,
    provider_map_url text,
