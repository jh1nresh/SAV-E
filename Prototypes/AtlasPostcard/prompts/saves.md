...
wax-like `3 need your review` seal, and quiet postmark lines. Keep the Root tab
bar fixed with Saves selected.

Do not turn tickets into ordinary list cards, put confirmed places in the
envelope, or scatter decorative pastel colors without state meaning.
